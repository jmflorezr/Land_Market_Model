...
df_IRV = pd.melt(df3, id_vars=['COD_MPIO'], value_vars=['IRV_2014','IRV_2015','IRV_2016','IRV_2017','IRV_2018','IRV_2019'], 
...
# Para COLOCACIONES
df_coloc = pd.melt(df3, id_vars=['COD_MPIO'], value_vars=['COLOCACIONES_2014','COLOCACIONES_2015','COLOCACIONES_2016','COLOCACIONES_2017','COLOCACIONES_2018','COLOCACIONES_2019'], 
...
df_ind_env_urb = pd.melt(df3, id_vars=['COD_MPIO'], value_vars=['INDICE ENVEJECIMIENTO URBANA_2014','INDICE ENVEJECIMIENTO URBANA_2015','INDICE ENVEJECIMIENTO URBANA_2016','INDICE ENVEJECIMIENTO URBANA_2017','INDICE ENVEJECIMIENTO URBANA_2018','INDICE ENVEJECIMIENTO URBANA_2019'], 
...
df_ind_env_rur = pd.melt(df3, id_vars=['COD_MPIO'], value_vars=['INDICE ENVEJECIMIENTO RURAL_2014','INDICE ENVEJECIMIENTO RURAL_2015','INDICE ENVEJECIMIENTO RURAL_2016','INDICE ENVEJECIMIENTO RURAL_2017','INDICE ENVEJECIMIENTO RURAL_2018','INDICE ENVEJECIMIENTO RURAL_2019'], 
...
df_ind_gob_ab = pd.melt(df3, id_vars=['COD_MPIO'], value_vars=['IND_GOB_ABIERTO_2014','IND_GOB_ABIERTO_2015','IND_GOB_ABIERTO_2016','IND_GOB_ABIERTO_2017','IND_GOB_ABIERTO_2018','IND_GOB_ABIERTO_2019'], 
...
df_porc_vr_agr_act_prim = pd.melt(df3, id_vars=['COD_MPIO'], value_vars=['PORC_VR_AGR_ACT_PRIM_2014','PORC_VR_AGR_ACT_PRIM_2015','PORC_VR_AGR_ACT_PRIM_2016','PORC_VR_AGR_ACT_PRIM_2017','PORC_VR_AGR_ACT_PRIM_2018','PORC_VR_AGR_ACT_PRIM_2019'], 
...
df_TASA_CREC_AR_CULT_PERM = pd.melt(df3, id_vars=['COD_MPIO'], value_vars=['TASA_CREC_AR_CULT_PERM_2014','TASA_CREC_AR_CULT_PERM_2015','TASA_CREC_AR_CULT_PERM_2016','TASA_CREC_AR_CULT_PERM_2017','TASA_CREC_AR_CULT_PERM_2018','TASA_CREC_AR_CULT_PERM_2019'], 
...
df_TASA_CREC_AR_CULT_TRANSIT = pd.melt(df3, id_vars=['COD_MPIO'], value_vars=['TASA_CREC_AR_CULT_TRANSIT_2014','TASA_CREC_AR_CULT_TRANSIT_2015','TASA_CREC_AR_CULT_TRANSIT_2016','TASA_CREC_AR_CULT_TRANSIT_2017','TASA_CREC_AR_CULT_TRANSIT_2018','TASA_CREC_AR_CULT_TRANSIT_2019'], 
...
formula = 'Predios_Cambio ~ 1 + Gini + PRurales + IRV + PoblCabecera + act_secundaria + act_terciaria + pot + COLOCACIONES + EntityEffects'
model = PanelOLS.from_formula(formula, data=df_panel)
results = model.fit()
print(results)
